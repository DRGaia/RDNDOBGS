from Kirjastojärjestelmä import kirjautuminen, lisäys, poisto, haku, tarkistus, lainaus, palautus, aika, sakko, muokkaus, historia; #Kaikki Ohjelma importit
...
while True:
    ...
    elif asiakas == True: # Avautuu vain jos käyttäjä on asiakas
        while True:
